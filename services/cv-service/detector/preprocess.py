...
def extract_face_grid(img: np.ndarray) -> list:
    """
    Divide image into 3x3 grid and return center region of each cell
    Uses tighter crop to avoid color bleeding between cells
    """
    h, w = img.shape[:2]

    # Use center 80% of image to avoid edges
